...
//                    ),appearance);
    ...
    // test Yellow aspect is invalid
    @Test
    public void testNoExternalYellowAspects(){
        SignalHead s = getHeadToTest();
        
        // Don't generate flash pulses for this test
        ((AbstractMqttSignalHead) s).setCanFlash(true);
        
        // Send an external Yellow command message to the Signal Head on the MQTT command topic
        ((AbstractMqttSignalHead) s).notifyMqttMessage(
                sendTopic,
                jmri.util.StringUtil.getNameFromState(
                        SignalHead.YELLOW,
        ...
        JUnitAppender.assertWarnMessage("Got unsupported Signal Head Appearance \"Yellow\" from MQTT topic track/signalhead/1");
        
     // Send an external Flashing Yellow command message to the Signal Head on the MQTT command topic
        ((AbstractMqttSignalHead) s).notifyMqttMessage(
                sendTopic,
                jmri.util.StringUtil.getNameFromState(
        ...
        JUnitAppender.assertWarnMessage("Got unsupported Signal Head Appearance \"Flashing Yellow\" from MQTT topic track/signalhead/1");
